...
The normality assumption for the full interaction model appears valid as the fitted values are randomly scatterd around mean zero and have constant variance for the explanatory variable age.  However, for the explanatory variable bmi, the assumption of constant variablity is dubious but the assumption of normally distributed residuals seems to hold.  
