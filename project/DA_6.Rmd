...
$$y_i = \alpha + \beta_{bmi} x_i +\beta_{age} x_i + \beta_{smoker} \cdot \mathbb{I}_{smoker}(i) + \beta_{bmi, smoker} \cdot \mathbb{I}_{bmi, smoker}(i) + \beta_{age, smoker} \cdot \mathbb{I}_{age, smoker}(i) +\epsilon_i$$
